 ...
 */
public class DangDangPersistence extends AbstractPersistence<ArrayList<CrawlerVO>> {
    ...
    public void registerShop(ArrayList<CrawlerVO> crawlerVOS) {
        ...
        arrayList.addAll((ArrayList<Seller>)sellerDao.getAllSellersByPlatform("dangdang"));
